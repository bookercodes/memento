...
var PasswordReboot = function(secret) {
  ...
  this.createToken = function createToken(user, minutesUntilExpiration) {
    minutesUntilExpiration = minutesUntilExpiration || 20;
    var expirationTime = moment().add({ minutes: minutesUntilExpiration }).unix();
